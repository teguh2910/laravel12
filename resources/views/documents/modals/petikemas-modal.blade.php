        ...
        <form id="petikemas-form" class="px-6 py-4">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="petikemas-seri" name="seri" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
