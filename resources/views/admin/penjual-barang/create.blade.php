...
@section('title', 'Tambah Penjual Barang')
@section('header', 'Tambah Penjual Barang')

@section('content')
<div class="px-4 sm:px-0">
    <div class="max-w-2xl">
        <form action="{{ route('admin.penjual-barang.store') }}" method="POST" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
            @csrf
